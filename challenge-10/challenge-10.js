  ...
  */
  function calculator(op) {
    if (!isOperatorValid(op)) {
      return console.log("Operador não válido");
    }
...
operationSignal = "*";
let multi = calculator(operationSignal);
if(multi) {
 num1 = 21;
 num2 = 4;
 console.log(showOperationMessage(operationSignal, num1, num2), multi(num1, num2))  
} else {
 console.log(showErrorMessage(operationSignal))
}
...
if(div) {
 num1 = 34;
 num2 = 2;
 console.log(showOperationMessage(operationSignal, num1, num2), div(num1, num2))  
} else {
 console.log(showErrorMessage(operationSignal))
}
